...
def fetch_yt_video(link):
    ydl_opts = {
        ...
        'extract_flat': True,  # Extract information as a flat dictionary
    }
...
connection = pymysql.connect(host='localhost', user='root', password='shrutika')
...
def run():
    st.title("Advance Resume Analyzer")
